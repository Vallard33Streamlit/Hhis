...
if filter_by_taux_couverture:
    taux_couverture = st.sidebar.slider("Rapport entre les exportations et les importations inférieur à :", min_value=0.0, max_value=3.0, value=1.0, step=0.1, format="%.2f")
